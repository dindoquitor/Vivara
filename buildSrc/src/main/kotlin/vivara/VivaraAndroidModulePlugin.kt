...
internal object VivaraAndroidModulePlugin {
...
class VivaraAndroidApplicationPlugin : Plugin<Project> {
    override fun apply(project: Project) = VivaraAndroidModulePlugin.configure(project, AndroidModuleType.APPLICATION)
}

class VivaraAndroidLibraryPlugin : Plugin<Project> {
    override fun apply(project: Project) = VivaraAndroidModulePlugin.configure(project, AndroidModuleType.LIBRARY)
}
