...
let vivaraPort = browser.runtime.connectNative("vivara_bg");

vivaraPort.onMessage.addListener(response => {
...
//vivaraPort.postMessage("Hello from WebExtension!");
...
browser.webRequest.onBeforeRequest.addListener(
    function (details) {
        ...
        vivaraPort.postMessage({ action: "onBeforeRequest", details: details });
        return promise;
    },
    { urls: ["<all_urls>"] },
    ["blocking"]
