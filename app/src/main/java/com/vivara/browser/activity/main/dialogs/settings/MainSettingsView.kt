...
import com.vivara.browser.activity.main.AdblockModel
import com.vivara.browser.activity.main.MainActivity
import com.vivara.browser.activity.main.SettingsModel
import com.vivara.browser.databinding.ViewSettingsMainBinding
...
class MainSettingsView @JvmOverloads constructor(
    ...
    private fun showRestartDialog() {
        AlertDialog.Builder(context)
            ...
            .setPositiveButton(R.string.exit) { _, _ ->
                ...
                Vivara.instance.needRestartMainActivityAfterExitingProcess = true
                activity!!.finish()
            }
            .setCancelable(false)
            .show()
    ...
    private fun initUAStringConfigUI(context: Context) {
        if (config.userAgentString.value?.contains("Vivara/1.0 ") == true) {//legacy ua string - now default one should be used
