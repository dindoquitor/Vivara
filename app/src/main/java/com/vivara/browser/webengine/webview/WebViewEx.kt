...
open class WebViewEx(context: Context, val callback: Callback, val jsInterface: AndroidJSInterface) : WebView(context) {
    companion object {
        ...
        const val WEB_VIEW_TAG = "Vivara WebView"
    ...
    init {
        ...
        webViewClient = object : WebViewClient() {
            ...
            override fun onReceivedHttpAuthRequest(
                ...
                val userNameEdit = EditText(context).also {
                    it.hint = context.getString(com.vivara.browser.common.R.string.username)
                    it.isSingleLine = true
                }
                val passwordEdit = EditText(context).also {
                    it.hint = context.getString(com.vivara.browser.common.R.string.password)
                    it.isSingleLine = true
        ...
        addJavascriptInterface(jsInterface, "Vivara")
    }
