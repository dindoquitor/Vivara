...
object HomePageHelper {
    ...
    fun shouldInterceptRequest(view: WebView, request: WebResourceRequest): WebResourceResponse? {
        ...
        if (request.url.scheme == "favicon") {
            ...
            //load images of vivara home from assets for offline mode
            val data = Vivara.instance.assets.open("pages/home" + request.url.path!!.replace("/appcontent/home", "")).use { it.readBytes() }
