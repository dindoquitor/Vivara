...
class WebViewWebEngine(val tab: WebTabState) : WebEngine, CursorDrawerDelegate.Callback {
    ...
    override fun togglePlayback() {
        webView?.evaluateJavascript("vivaraTogglePlayback()", null)
    }

    override fun stopPlayback() {
        webView?.evaluateJavascript("vivaraStopPlayback()", null)
    }

    override fun rewind() {
        webView?.evaluateJavascript("vivaraRewind()", null)
    }

    override fun fastForward() {
        webView?.evaluateJavascript("vivaraFastForward()", null)
    }
