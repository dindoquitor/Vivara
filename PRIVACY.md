...
This policy describes how **Vivara** (“the application”) handles information. The application is open-source software. The application is open-source software.
...
Vivara is a **web browser**. When you browse the internet:
